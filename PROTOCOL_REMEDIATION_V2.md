...
Declared after the revision-1 failure and before any revision-2 neural predictions. Revision 1 remains failed, with all six seeds retained. This experiment tests a documented input-representation remedy; it is not a retrospective change to the original gate.
...
One L4 container, no retries, min containers 0, max 1, 6000-second function timeout, 750-second per-inference timeout. Reserve at most $10 of the initially reported $200 free Modal allowance for this experiment; reconcile account meter afterward. This is a local planning reserve, not a provider-enforced spending cap. No payment method, purchase, deployment or wet-lab dispatch is added.
